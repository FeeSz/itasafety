    ...
    <div className="mx-auto max-w-7xl px-6 py-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-ink-muted">Gerencie os departamentos do catálogo.</p>
        </div>
        <button
      ...
      <AlertDialog open={!!deleteId} onOpenChange={(o) => !o && setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação é permanente. Produtos vinculados manterão a referência textual.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
        ...
        <div className="space-y-4">
          <FormRow label="Nome">
            <input
              ...
              className="input"
              placeholder="Ex: Proteção Visual"
            />
          </FormRow>
