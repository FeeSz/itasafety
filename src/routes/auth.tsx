...
function AuthPage() {
  ...
  const handleSocialLogin = (provider: "google" | "apple") => {
    toast.info(`Conectando com o ${provider === "google" ? "Google" : "Apple"}...`);
    // Simulando login
    setTimeout(() => {
      toast.success("Login social simulado com sucesso!");
        ...
        <div className="mb-5 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex min-h-[48px] items-center justify-center gap-2 rounded-xl border border-hairline bg-white px-4 py-2.5 text-sm font-semibold text-ink shadow-sm transition-all hover:bg-slate-50 hover:shadow dark:border-white/10 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700"
            >
          ...
          <button
            ...
            className="flex w-full min-h-[48px] items-center justify-center gap-2 rounded-xl border border-dashed border-brand-blue/30 bg-brand-blue/5 px-4 py-3 text-sm font-semibold text-brand-blue shadow-sm transition-all hover:bg-brand-blue/10 hover:border-brand-blue/50"
          >
            <svg
