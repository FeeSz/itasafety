...
export default function SearchBox({
  ...
  return (
    <div className="relative w-full">
      <div
        className={`flex items-center gap-2 rounded-full border border-[#E5E7EB] bg-white px-4 ${inputCls}`}
      >
                ...
                <li key={p.sku}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate text-[13px] font-semibold text-[#111]">{p.name}</p>
